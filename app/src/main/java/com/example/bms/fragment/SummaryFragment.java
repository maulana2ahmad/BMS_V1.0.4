...
import com.example.bms.OnBackPressed;
...
public class SummaryFragment extends Fragment {
    ...
    private String DEFAULT_ERROR_PAGE_PATH = "file:///android_asset/html/errorhtml/default_error_page.html";
    ...
    private void LoadWeb() {
        ...
        //wbSummry.addJavascriptInterface(new SimpleWebJavascriptInterface(SummaryFragment), "Android");
        ...
        wbSummry.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String javascriptM="javascript:document.getElementById(\\\"countUp\\\").setAttribute(\\\"style\\\",\\\"display:none;\\\");";
    ...
    private class SimpleWebJavascriptInterface {

        private Activity activity;

        public SimpleWebJavascriptInterface(SummaryFragment activity) {
